...
Fetcher.prototype.options = function(options) {
  options = options || {};
  this.verbose = options.verbose || this.verbose || false; //TODO: Fix, this will not work when setting verbose to false
